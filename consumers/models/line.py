...
class Line:
    ...
    def process_message(self, message):
        ...
        if message.topic() == 'stations.faust.table': # Set the conditional correctly to the stations Faust Table
            try:
                print(message.value())
        ...
        elif "com.udacity.project.station" in message.topic(): # Set the conditional to the arrival topic
